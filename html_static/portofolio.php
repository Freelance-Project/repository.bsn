...
<div id="portofolio-content">
    <div class="box-paper">
        <div class="pen"><img src="images/material/pen.png"></div>
        <div class="top-porto">
            <div class="left-top">
                <h1 class="name">Rico <br> Jackson</h1>
                <p class="title"><i>Graphic Desainer</i></p>
            </div>
            <div class="right-top">
                <address>
        ...
        <div class="bottom-porto">
            <div class="left-bottom">
                ...
                <div class="left-rows">
                    ...
                    <p><strong>Your position here, 2015-Present<br>company name, Location</strong></p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin fermentum hendrerit arcu ut eleifend. Vestibulum pulvinar eros at diam scelerisque facilisis sed et arcu. Ut laoreet finibus mi ac ultricies. Donec vitae dictum mi, non placerat dolor.</p><br>
            ...
            <div class="right-bottom">
                ...
                <div class="right-rows">
                    ...
                    <p><strong>2007-20011</strong></p>
                    <p><strong>Your Deegree, your title</strong><br>Name university</p><br>

                    <p><strong>2007-20011</strong></p>
                    <p><strong>Your Deegree, your title</strong><br>Name university</p>
                </div>
                <div class="right-rows social-row">
